...
<p align="center">
  <b>We work bbarit — 1인 개발자와 소규모 개발팀을 위한 올인원 멤버십</b>
</p>
...
혼자서도 **빠릿하게 만들고**, **빠릿하게 런칭**할 수 있게.
강의 + 개발도구 + 마케팅 도구 + 커뮤니티를 한 번에 묶었습니다.

- **1인 1멤버십** · 1년 66만원 · 부가세 포함
- **카카오톡 결제(결제선생)** · 자동갱신 없음
- **단일 플랜** · 회원이 되면 9개 제품 전부 사용
...
1. [bbarit.com](https://bbarit.com) 접속 → **GitHub로 시작하기** 클릭
2. 멤버십 결제 (카카오톡 결제 · 1년 66만원)
3. [포털](https://bbarit.com/app) 에서 빠릿터미널 · 빠릿캡처스 다운로드
4. [빠릿클래스](https://bbarit.com/app/class) 에서 강의 시작

---

## 커뮤니티 · CS

- **CS 이슈**: [bbarit/community](https://github.com/bbarit/community/issues) — 제품별 라벨 자동 분류
- **티켓**: [포털 > CS 티켓](https://bbarit.com/app/tickets) — 로그인하면 바로 이슈 등록 링크
- **공지 · QnA**: [Community Discussions](https://github.com/bbarit/community/discussions)
...
| 영역 | 라벨 |
|---|---|
| 제품 | `빠릿터미널` · `빠릿캡처스` · `빠릿워커스` · `빠릿바이브` · `빠릿디자인` · `빠릿프레스` · `빠릿메일` · `빠릿북스` · `빠릿클래스` · `마케케` |
| 플랫폼 | `맥OS` · `윈도우` |
| 심각 | `크래시` · `데이터 손실` · `보안 이슈` |
| 오류 | `로그인 오류` · `결제 오류` · `다운로드 오류` · `업데이트 오류` · `버그` |
| 품질 | `성능 이슈` · `UI 버그` · `번역/로컬라이즈` · `호환성` · `통합 이슈` |
| 개선·제안 | `개선 제안` · `새 기능` · `접근성` · `문서 개선` |
| 문의 | `결제·환불` · `접근 권한` · `일반 문의` · `질문` |
| 운영 | `공지` · `릴리즈 노트` · `로드맵` |
| 상태 | `검토 중` · `재현 완료` · `진행 중` · `수정 완료` · `배포 완료` · `보류` · `사용자 응답 대기` |
...
<p align="center">
  <sub>
    <a href="https://bbarit.com">bbarit.com</a> ·
    <a href="https://makeke.kr">makeke.kr</a> ·
    <a href="https://books.bbarit.com">books.bbarit.com</a>
  </sub>
</p>
